      ...
      >
        <div class="space-y-6 md:space-y-10 mt-10">
          ...
          <h1 class="hidden md:block font-bold text-sm md:text-xl text-center">
            Account<span class="text-teal-600">.</span>
          </h1>
          <div id="profile" class="flex text-center flex-col justify-center items-center space-y-3">
            <FaUser class="items-center"/>
            <div>
              <h2
              ...
              <p class="text-xs text-gray-500 text-center">ANOTHER LINE OF INFORMATION</p>
            </div>
          </div>
          ...
          <div id="menu" class="flex flex-col space-y-2">
            ...
            <a
              href=""
              class="flex flex-row text-sm font-medium text-gray-700 py-2 px-2 hover:bg-teal-500 hover:text-white hover:scale-105 rounded-md transition duration-150 ease-in-out"
            >
              <FaPiggyBank class="mx-1 flex justify-center items-center"/>
                <path
